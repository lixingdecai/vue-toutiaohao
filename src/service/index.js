...
const fetchCommentList = () => {
  const d = new $.Deferred();
  let data = '{"code":0,"data":{"page_info":{"page":1,"total_number":5,"total_page":1,"page_size":20},"data":[{"id":100117,"news_id":1574770,"content":"共和国","user_id":107993425,"user_screen_name":"原始昵称过后","news_user_id":105038491,"created_at":1490950806,"review_num":0,"praise_num":0,"avatar":"","title":"良心更新！各代iPhone升级iOS10.3速度体验获好评","is_fans":0,"is_praise":0,"type":4},{"id":68655,"news_id":1563933,"content":"啊","user_id":105028513,"user_screen_name":"my-shenfh","news_user_id":105038491,"created_at":1489981739,"review_num":0,"praise_num":0,"avatar":"https://sc.my.com/avatar_105028513","title":"视频测试1视频测试1视频测试1视频测试1视频测试1视频测试1视频测试1视频测试1视频测试1视频测试1视频测试1","is_fans":0,"is_praise":0,"type":4},{"id":68632,"news_id":1563935,"content":"啊","user_id":98786262,"user_screen_name":"新伟1022","news_user_id":105038491,"created_at":1489752238,"review_num":"1","praise_num":0,"avatar":"https://sc.my.com/avatar_98786262","title":"视频测试11","is_fans":0,"is_praise":0,"type":4},{"id":68630,"news_id":1563935,"content":"A","user_id":105028513,"user_screen_name":"my-shenfh","news_user_id":105038491,"created_at":1489752097,"review_num":"1","praise_num":0,"avatar":"https://sc.my.com/avatar_105028513","title":"视频测试11","is_fans":0,"is_praise":0,"type":4},{"id":68620,"news_id":1563933,"content":"1","user_id":98786262,"user_screen_name":"新伟1022","news_user_id":105038491,"created_at":1489745273,"review_num":0,"praise_num":0,"avatar":"https://sc.my.com/avatar_98786262","title":"视频测试1视频测试1视频测试1视频测试1视频测试1视频测试1视频测试1视频测试1视频测试1视频测试1视频测试1","is_fans":0,"is_praise":0,"type":4}]},"message":""}';
  data = JSON.parse(data);
  d.reject(data);
  return d.promise();
};
...
const fetchFriendshipList = () => {
  const d = new $.Deferred();
  let data = '{"code":0,"data":{"page_info":{"page":1,"total_number":2,"total_page":1,"page_size":20},"data":[{"id":107992262,"avatar":"https://sc.my.com/avatar_107992262","screen_name":"小熊啊l lo lo","location":"厦门","mode":3,"isvip":0,"type":2,"status_code":0,"created_at":1487249214,"relation":2}]},"message":""}';
  data = JSON.parse(data);
  d.reject(data);
  return d.promise();
};
...
const fetchArticleList = () => {
  const d = new $.Deferred();
  let data = '{"code":0,"data":{"page_info":{"page":1,"total_number":177,"total_page":9,"page_size":20},"data":[{"id":1585864,"title":"asdasdfasd","created_at":1493108517,"published_date":"2017-04-25 16:21:57","view_times":0,"review_count":0,"category_id":7,"flat_images":"http://mycdn.my.com/news/img/5c31ccd4d7de69981d89f16e2079b5f5_470_313.jpg","status":4,"video_flat_thumb":"","share_count":0,"collect_count":0,"type":2,"reason_id":0,"audited_at":"","show_times":0,"thumb":"http://mycdn.my.com/news/img/5c31ccd4d7de69981d89f16e2079b5f5_470_313.jpg","video_thumb":"","is_top":0,"category_name":"美食指南","reason_name":""}]},"message":""}';
  data = JSON.parse(data);
  d.resolve(data);
  return d.promise();
};
...
const fetchArticleDetail = () => {
  const d = new $.Deferred();
  let data = '{"code":0,"data":{"images":[{"src":"https://sc.my.com/mp_1754632952.jpg","remark":""},{"src":"https://sc.my.com/mp_3086041156.jpg","remark":""},{"src":"https://sc.my.com/mp_1760473578.jpg","remark":""}],"content":"<div><p>工业时代的发展，带来了灰蒙蒙的雾霾天，</p><p>如今“晒蓝天”已经成了一种我们的心情常态，</p><p>偶尔的晴空万里也能成为我们朋友圈里的热点，</p><p>不过我们现在不用愁看不到蓝天了，</p><p>意大利的著名物理学家兼光学教授Paolo di Trapani ，</p><p>开发出了一种日光模拟设备&nbsp;――&nbsp;CoeLux系统，</p><p>CoeLux能模拟出太阳光，还有十分逼真的蓝天，</p><p>让你无论在何时何地，都能感受到阳光的温暖。</p><p>...</p><p>-CoeLux-&nbsp;</p><p><br/></p><p>我们先来看看CoeLux所展现的效果~</p><p>▼</p><p><img data-src="https://sc.my.com/mp_1754632952.jpg" class="mu-ue-image" src="https://sc.my.com/mp_1754632952.jpg"/></p><p><br/></p><p>嗯？这不就是一扇天窗嘛，有什么稀奇的？</p><p>不过，如果你真觉得这是一扇天窗的话你就被骗了~</p><p>其实CoeLux是一款平面照明装置，</p><p>一盏可以让阳光住进你的房间的灯~</p><p><br/></p><p><img data-src="https://sc.my.com/mp_3086041156.jpg" class="mu-ue-image" src="https://sc.my.com/mp_3086041156.jpg"/><img data-src="https://sc.my.com/mp_1760473578.jpg" class="mu-ue-image" src="https://sc.my.com/mp_1760473578.jpg"/></p><p><br/></p><p>没错，这家伙真的就是个灯而已，</p><p>但若是往里面看，</p><p>你会感觉到正在看几十公里外蓝天，</p><p>而且还能看到一个栩栩如生的太阳。</p><p><br/></p></div>","multi_video":[],"title":"asdasdfasd","category_id":7,"type":2,"id":1585864,"thumbs":[{"src":"https://mycdn.my.com/news/img/5c31ccd4d7de69981d89f16e2079b5f5_470_313.jpg"}],"status":4,"created_at":"2017-04-25 16:21:57"},"message":""}';
  data = JSON.parse(data);
  d.resolve(data);
  return d.promise();
};
